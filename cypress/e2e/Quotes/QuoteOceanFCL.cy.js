...
describe('template spec', () => {
  ...
  //  ///////////// Destination /////////
   cy.get(':nth-child(2) > .mb-2 > .relative > .p-autocomplete > .p-autocomplete-input').type('Quebec')
   cy.get('#pv_id_4_0').contains('Canada').click()

   ////// SELECTING THE OCEAN SERVICE -- FCL SERVICE ///////
   cy.get('[for="oceanServiceFCL"]').click()
